"""
Script Title: edit_npy_files.py
Author: Petter Hangerhagen
Email: petthang@stud.ntnu.no
Date: July 4th, 2024
Description: This script was used to remove certain tracks from the radar data. 
This to get a clearer visualization of the data, since unnecessary tracks for the situation were removed.
"""
